...
class TestTextProcessor(unittest.TestCase):
    ...
    def test_remove_stopwords(self):
        ...
        with given():
            ...
            english_tokens = ["the", "quick", "brown", "fox", "jumps", "over", "the", "lazy", "dog"]
    ...
    def test_prepare_for_fasttext(self):
        ...
        with when("preparing English texts without removing stopwords"):
            processed_english = processor.prepare_for_fasttext(english_texts, "english", remove_stopwords=False)
        ...
        with when("preparing English texts and removing stopwords"):
            processed_english = processor.prepare_for_fasttext(english_texts, "english", remove_stopwords=True)
