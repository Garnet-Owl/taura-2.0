"""
Implementation of the Book of 1 Thessalonians extractor.
"""
...
from app.preprocessing.bible.thessalonians1.core import (
    Thessalonians1Extractor as Thessalonians1ExtractorBase,
)

_UPPER = r"[\"''A-Z\u00C0-\u017F]"


class Thessalonians1Extractor(BaseBibleParser, Thessalonians1ExtractorBase):
    """
    Extractor to parse, clean, and align the Book of 1 Thessalonians.
    """

    def __init__(self):
        Thessalonians1ExtractorBase.__init__(self)
    ...
    def _get_clamped_page_range(
        ...
        end_ref_clamped = (
            end_ref if end_ref[0] == target_book else (target_book, 5, 28)
        )
    ...
    def extract_and_align(
        ...
        print("Extraction Validation for 1 Thessalonians:")
