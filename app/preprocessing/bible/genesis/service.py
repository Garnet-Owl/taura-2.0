"""
Implementation of the Book of Genesis extractor.
"""
...
from app.preprocessing.bible.genesis.core import GenesisExtractor as GenesisExtractorBase

_UPPER = r"[\"'A-Z\u00C0-\u017F]"

class GenesisExtractor(BaseBibleParser, GenesisExtractorBase):
    """
    Extractor to parse, clean, and align the Book of Genesis.
    """

    def __init__(self):
        GenesisExtractorBase.__init__(self)
    ...
    def extract_and_align(
        ...
        print(f"Extraction Validation for Genesis:")
