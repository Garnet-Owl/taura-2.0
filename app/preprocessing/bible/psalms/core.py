"""
Core definitions and structural specifications for the Book of Psalms.
"""

from typing import Dict, List, Tuple


class PsalmsExtractor:
    ENGLISH_NAME = "Psalms"
    KIKUYU_NAME = "Thaburi"

    KIKUYU_START_PAGE = 598
    KIKUYU_END_PAGE = 737
    ENGLISH_START_PAGE = 569
    ENGLISH_END_PAGE = 651
