"""
Implementation of the Book of Isaiah extractor.
"""
...
from app.preprocessing.bible.isaiah.core import IsaiahExtractor as IsaiahExtractorBase

_UPPER = r"[\"'A-Z\u00C0-\u017F]"

class IsaiahExtractor(BaseBibleParser, IsaiahExtractorBase):
    """
    Extractor to parse, clean, and align the Book of Isaiah.
    """

    def __init__(self):
        IsaiahExtractorBase.__init__(self)
    ...
    def extract_and_align(
        ...
        print(f"Extraction Validation for Isaiah:")
