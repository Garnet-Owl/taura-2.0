"""
Implementation of the Book of Acts (Atũmwo) extractor.
"""
...
from app.preprocessing.bible.acts.core import ActsExtractor as ActsExtractorBase

_UPPER = r"[\"''" "A-ZĨŨÀ-ÞĀ-ſ]"


class ActsExtractor(BaseBibleParser, ActsExtractorBase):
    """
    Extractor to parse, clean, and align the Book of Acts.
    """

    def __init__(self):
        ActsExtractorBase.__init__(self)
    ...
    def _get_clamped_page_range(
        ...
        end_ref_clamped = (
            end_ref if end_ref[0] == target_book else (target_book, 28, 31)
        )
    ...
    def extract_and_align(
        ...
        print("Extraction Validation for Acts:")
