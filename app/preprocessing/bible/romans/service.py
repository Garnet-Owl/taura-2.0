"""
Implementation of the Book of Romans (Aroma) extractor.
"""
...
from app.preprocessing.bible.romans.core import RomansExtractor as RomansExtractorBase

_UPPER = r"[\"''" "A-ZĨŨÀ-ÞĀ-ſ]"


class RomansExtractor(BaseBibleParser, RomansExtractorBase):
    """
    Extractor to parse, clean, and align the Book of Romans.
    """

    def __init__(self):
        RomansExtractorBase.__init__(self)
    ...
    def _get_clamped_page_range(
        ...
        end_ref_clamped = (
            end_ref if end_ref[0] == target_book else (target_book, 16, 27)
        )
    ...
    def extract_and_align(
        ...
        print("Extraction Validation for Romans:")
