"""
Implementation of the Book of Ephesians extractor.
"""
...
from app.preprocessing.bible.ephesians.core import (
    EphesiansExtractor as EphesiansExtractorBase,
)

_UPPER = r"[\"''A-Z\u00C0-\u017F]"


class EphesiansExtractor(BaseBibleParser, EphesiansExtractorBase):
    """
    Extractor to parse, clean, and align the Book of Ephesians.
    """

    def __init__(self):
        EphesiansExtractorBase.__init__(self)
    ...
    def _get_clamped_page_range(
        ...
        end_ref_clamped = (
            end_ref if end_ref[0] == target_book else (target_book, 6, 24)
        )
    ...
    def extract_and_align(
        ...
        print("Extraction Validation for Ephesians:")
