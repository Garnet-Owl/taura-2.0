"""
Core definitions and structural specifications for the Book of Colossians.
"""

from typing import Dict, List, Tuple


class ColossiansExtractor:
    ENGLISH_NAME = "Colossians"
    KIKUYU_NAME = "Akolosai"

    KIKUYU_START_PAGE = 1412
    KIKUYU_END_PAGE = 1415
    ENGLISH_START_PAGE = 1491
    ENGLISH_END_PAGE = 1494
