"""
Implementation of the Book of Proverbs extractor.
"""
...
from app.preprocessing.bible.proverbs.core import ProverbsExtractor as ProverbsExtractorBase

_UPPER = r"[\"'A-Z\u00C0-\u017F]"

class ProverbsExtractor(BaseBibleParser, ProverbsExtractorBase):
    """
    Extractor to parse, clean, and align the Book of Proverbs.
    """

    def __init__(self):
        ProverbsExtractorBase.__init__(self)
    ...
    def extract_and_align(
        ...
        print(f"Extraction Validation for Proverbs:")
